app.controller('BooksController',['$scope', function($scope, $http, $routeParams){
  libros = [
           {
             "id": "1",
...
app.controller('BooksSheetController',['$http', '$scope', '$routeParams', function($http, $scope, $routeParams){
